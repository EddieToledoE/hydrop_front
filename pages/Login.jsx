    ...
    try {
      ...
      if (error instanceof AxiosError) {
        ...
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "Ha ocurrido un error" + error.response?.data.message,
        });
      }
    }
  };
          ...
          <div className="contenido-derecha">
            <div className="encabezado">
              <div className="contenido-encabezado">
                ...
                <br />
                <br />
                <h2 className="h2-2">Inicio de sesión</h2>
                <br />
          ...
          <div className="contenido-derecha">
            <div className="encabezado">
              <div className="contenido-encabezado">
                ...
                <br />
                <br />
                <h2 className="h2-2">Recuperar contraseña</h2>
                <br />
                <br />
                <span>
